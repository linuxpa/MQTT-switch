var name = "Luce Ufficio";
var lightIDString = "01"
var serialNumber = "LGHT0001";
var userName = "1A:2B:3C:4E:3D:AB";
var controlTopic = '/luce/uficio/stato'
...
client.on('message', function (topic, message) {
  ...
  if (message != "") {
    ...
    if (status[0] == lightIDString) {
     ...
     if (BEDROOM_LIGHT.powerOn == true){

          BEDROOM_LIGHT.powerOn = false;
          client.publish(controlTopic, '0');

//  Aggiornamento realtime dello stato in IOS
    light
     ...
     else if (BEDROOM_LIGHT.powerOn == false){

         BEDROOM_LIGHT.powerOn = true;
...
light
  ...
  .setCharacteristic(Characteristic.Manufacturer, "Lino")
